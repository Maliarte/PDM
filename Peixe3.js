...
const Peixe3 = () => {
  ...
  const PedidoFinalizado = () => {
    ...
    'Betta FurtaCor  precisa de alimentação 3x/dia \n\nObrigado pela preferência!'
    );
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.containerTitulo}>
        <Text style={styles.titulo}>
         Betta FurtaCor é rebelde, sua cauda é de dar inveja!
        </Text>
      </View>
        ...
        <View style={{gap: 16}}>
          <View>
            <View style={{flexDirection: 'row', alignItems: 'baseline'}}>
              ...
              <Text style={styles.textoPequeno}>(NOODLES FRITOS)</Text>
            </View>
      ...
      <View style={{marginTop: 30}}>
        ...
        <View style={{ flexDirection: 'row', gap: 4, marginTop: 4 }}>
          ...
          <View style={{ backgroundColor: '#D9D9D9', padding: 2, borderRadius: 2, width: 38, height: 15, marginTop: 1}}>
            <Text style={{ fontFamily: 'LailaBold', fontWeight: 700, fontSize: 6.5, color: '#000'}}>Z6-H9ZPF3</Text>
          </View>
