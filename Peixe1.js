...
const Peixe1 = () => {
  ...
  const PedidoFinalizado = () => {
    ...
    'Betta Azul precisa de alimentação 3x/dia. \n\nObrigado pela preferência!'
    );
        ...
        <View style={{gap: 16}}>
          <View>
            <View style={{flexDirection: 'row', alignItems: 'baseline'}}>
              <Text style={styles.nomeProduto}>betta blue- </Text>
              <Text style={styles.textoPequeno}>(Betta Azul)</Text>
            </View>
      ...
      <View style={{marginTop: 30}}>
        ...
        <View style={{ flexDirection: 'row', gap: 4, marginTop: 4 }}>
          ...
          <View style={{ backgroundColor: '#D9D9D9', padding: 2, borderRadius: 2, width: 38, height: 15, marginTop: 1}}>
            <Text style={{ fontFamily: 'LailaBold', fontWeight: 700, fontSize: 6.5, color: '#000'}}>X4-H1ZLF9</Text>
          </View>
